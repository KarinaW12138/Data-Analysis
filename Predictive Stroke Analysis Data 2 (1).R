...
# Appendix: Data Manipulations, Modeling Methods, and Results
...
knitr::kable(metrics, caption = "Model Performance Comparison (threshold = 0.50)")
...
# Threshold Sensitivity Analysis (0.10 cutoff) 
